...
import type {
  InternalBribe,
  InternalBribeInterface,
} from "../../contracts/InternalBribe";
...
const _abi = [
  ...
  "function userRewardPerTokenStored(address,uint256) view returns (uint256)",
  "function voter() view returns (address)",
] as const;

export class InternalBribe__factory {
  static readonly abi = _abi;
  static createInterface(): InternalBribeInterface {
    return new utils.Interface(_abi) as InternalBribeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): InternalBribe {
    return new Contract(address, _abi, signerOrProvider) as InternalBribe;
  }
}
